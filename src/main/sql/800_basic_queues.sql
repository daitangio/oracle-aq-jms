...
exec aq_jms_pkg.ensure_jmstext_queue_exists('GPE_COMMANDER_PROD');
exec aq_jms_pkg.ensure_jmstext_queue_exists('GPE_COMMANDER_jj');
exec aq_jms_pkg.ensure_jmstext_queue_exists('GPE_COMMANDER_vtpie'); 
exec aq_jms_pkg.ensure_jmstext_queue_exists('GPE_COMMANDER_mondino');
